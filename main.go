...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:   "45801eff.example.zoncoen.net",
	})
	if err != nil {
	...
	if err = (&storev1.PizzaOrder{}).SetupWebhookWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create webhook", "webhook", "PizzaOrder")
		os.Exit(1)
	}
